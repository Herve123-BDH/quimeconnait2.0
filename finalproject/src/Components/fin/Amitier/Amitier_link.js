...
export const Amitier_link = () => {
    ...
    const[url, setUrl]=useState(`Bonjour, viens jouer a qui me connait, je saurais la personne qui me connait le mieux au monde 😍😍😍 http://localhost:3000/PlayAmitier/${user.id}`)
    return (
