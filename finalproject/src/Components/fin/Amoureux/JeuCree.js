...
export const JeuCree = () => {
    ...
    const[url, setUrl]=useState(`Bonjour, viens jouer a qui me connait special amoureux, je saurais mon amoureux qui me connait le mieux 😍😍😍 https://quimeconnait.herokuapp.com/PlayAmrx/${user.id}`)
    return (
