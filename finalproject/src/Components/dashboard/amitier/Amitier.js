        ...
        <div className="amraaa">
            {
                ...
                {cool==Question.length-1?<Link to='/dashboard/jeucree-amitier'><img  style={{cursor: "pointer", width: "150px"}} src={Finish} onClick={()=>{
                    console.log(answers)
                    setPro(100)
                    setTimeout(() => {
                        setOk(0)
